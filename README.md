...
| 🦷 Dent Flow |
|-------------|
| ![Dent Flow](screenshots/dark/dent-flow.png) |

| ➕ Booking Form |
|-------------|
| ![Booking Form](screenshots/dark/booking-form.png) |

| 🏠 Dashboard |
|-------------|
| ![Dashboard](screenshots/dark/dash-board.png) |

| 📝 Patient Card |
|-------------|
| ![Patient Card](screenshots/dark/patient-card.png) |

| ⚙️ Settings Panel |
|-------------|
| ![Settings](screenshots/dark/settings-modal.png) |
